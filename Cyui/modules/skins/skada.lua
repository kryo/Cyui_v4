...
if not IsAddOnLoaded("Skada") or C.skin.skada ~= true then return end
...
function EmbedSkada()
	if(#windows == 1) then
		EmbedWindow(windows[1], TukuiChatBackgroundRight:GetWidth() - 4, ( TukuiChatBackgroundRight:GetHeight() - 4 - ( barSpacing * 4 ) ) / 10, ( TukuiChatBackgroundRight:GetHeight()-4 ), "BOTTOMRIGHT", TukuiChatBackgroundRight, "BOTTOMRIGHT", -2, 2)
	elseif( #windows == 2 ) then
		EmbedWindow(windows[1], ( ( TukuiChatBackgroundRight:GetWidth() - 4 ) / 2 ) - ( borderWidth + T.mult ), ( TukuiChatBackgroundRight:GetHeight() - 4 - ( barSpacing * 4 ) ) / 10, TukuiChatBackgroundRight:GetHeight(), "BOTTOMRIGHT", TukuiChatBackgroundRight, "BOTTOMRIGHT", -2, 2)
		EmbedWindow(windows[2], ( ( TukuiChatBackgroundRight:GetWidth() - 4 ) / 2 ) - ( borderWidth + T.mult ), ( TukuiChatBackgroundRight:GetHeight() - 4 - ( barSpacing * 4 ) ) / 10, TukuiChatBackgroundRight:GetHeight(), "BOTTOMLEFT", TukuiChatBackgroundRight, "BOTTOMLEFT", 2, 2)
	elseif( #windows > 2 ) then
		EmbedWindow(windows[1], ( ( TukuiChatBackgroundRight:GetWidth() - 4 ) / 2 ) - ( borderWidth + T.mult ), ( TukuiChatBackgroundRight:GetHeight() - 4 - ( barSpacing * 4 ) ) / 10, TukuiChatBackgroundRight:GetHeight(), "BOTTOMRIGHT", TukuiChatBackgroundRight, "BOTTOMRIGHT", -2, 2)
		EmbedWindow(windows[2], ( ( TukuiChatBackgroundRight:GetWidth() - 4 ) / 2 ) - ( borderWidth + T.mult ), ( ( TukuiChatBackgroundRight:GetHeight() - 6 / 2 ) - ( barSpacing * 4 ) ) / 10, TukuiChatBackgroundRight:GetHeight() / 2 - 2,  "BOTTOMLEFT", TukuiChatBackgroundRight, "BOTTOMLEFT", 2, 2)
...
if C["skin"].embedright == "skada" then
	...
	if(G.Panels.RightChatTabsBackground) then
		local button = CreateFrame("Button", "SkadaToggleSwitch", TukuiTabsLeftBackground)
		button:Width(90)
		button:Height(TukuiTabsLeftBackground:GetHeight() - 4)
		button:Point("RIGHT", TukuiTabsLeftBackground, "RIGHT", -2, 0)
		button:SetFrameStrata("HIGH")

		button.tex = button:CreateTexture(nil, "OVERLAY")
		button.tex:SetTexture(C["media"].pulse)
		button.tex:Point("TOPRIGHT", -2, 0)
		button.tex:Height(button:GetHeight() -4)
		button.tex:Width(16)

		button:FontString(nil, unpack(T.Fonts.uGeneral.setfont))
		...
		button:SetScript("OnLeave", function(self) button.text:SetText(nil) end)
